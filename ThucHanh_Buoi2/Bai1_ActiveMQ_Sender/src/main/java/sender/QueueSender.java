...
public class QueueSender {
	public static void main(String[] args) throws Exception {
		...
		settings.setProperty(Context.PROVIDER_URL, "tcp://localhost:99999");
		//create context
		...
		//create text message
		Message msg = session.createTextMessage("Hello Nguyen Viet Hoc, This is a mesage from ActiveMQ");
		producer.send(msg);
